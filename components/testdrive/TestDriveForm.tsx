...
/**
 * Test drive request form. Shared by the home page section (§5.1) and the
 * standalone /book-test-drive page, so the two can never drift apart.
 *
 * `defaultModel` pre-selects a vehicle when arriving from a model page.
 */
export default function TestDriveForm({
  ...
  const {
    ...
    // Validate on blur so problems surface field by field, not all at submit.
    mode: "onTouched",
    defaultValues: {
      name: "",
      phone: "",
      ...
      {submitted ? (
        ...
        >
          ...
          <p className="measure mt-3 text-[15px] leading-relaxed text-ink-muted">
            Thank you. A product advisor from your chosen dealer will call to
        ...
        >
          ...
          <div className="pt-3">
            ...
            <p className="mt-4 text-center text-[12px] leading-relaxed text-ink-muted">
              ...
              Demonstration form — nothing is transmitted.
            </p>
          </div>
        </motion.form>
      )}
